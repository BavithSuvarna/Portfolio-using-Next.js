      ...
      <div className="max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between gap-8 px-4">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-transparent text-5xl sm:text-5xl lg:text-7xl lg:whitespace-nowrap font-thin pb-4"
          >
            Hey! I'm Bavith
          </motion.h1>
          ...
          <motion.p
            ...
            initial="hidden"
            animate="visible"
            className="text-base sm:text-lg lg:text-xl font-light tracking-tight leading-relaxed"
          >
            {HERO_CONTENT}
          </motion.p>
        ...
        <div className="w-full lg:w-1/2 flex justify-center mt-16">
          <motion.img
            ...
            src="/assets/BavithSuvarnaProfile.png"
